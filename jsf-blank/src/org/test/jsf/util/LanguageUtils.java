...
public class LanguageUtils {
	private static String[] languages = { "Java", "JavaScript", "C#", "C++",
			"PHP", "Python", "Perl", "Ruby", "Scala" };
	...
	// Could have bad performance unless you are sure that the number of
	// languages
	...
	public static List<String> randomLanguages(int numLanguages) {
		if (numLanguages >= languages.length) {
			...
			for (int i = 0; i < numLanguages; i++) {
				randomLanguages.add(uniqueRandomLanguage(randomLanguages,
						languages));
			}
